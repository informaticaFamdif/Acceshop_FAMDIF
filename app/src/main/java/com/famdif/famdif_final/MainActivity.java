...
import com.famdif.famdif_final.fragment.AboutUsFragment;
import com.famdif.famdif_final.fragment.AccederFragment;
import com.famdif.famdif_final.fragment.AchievementsFragment;
import com.famdif.famdif_final.fragment.BusquedaFragment;
import com.famdif.famdif_final.fragment.BusquedaSugerenciaFragment;
import com.famdif.famdif_final.fragment.BusquedaSugerenciaFragmentResult;
import com.famdif.famdif_final.fragment.BusquedaTiendaValorarResultFragment;
import com.famdif.famdif_final.fragment.BusquedaUsuarioFragment;
import com.famdif.famdif_final.fragment.BusquedaValorarTiendaFragment;
import com.famdif.famdif_final.fragment.CrearTiendaFragment;
import com.famdif.famdif_final.fragment.EditShopFragment;
import com.famdif.famdif_final.fragment.FirstTimeFragment;
import com.famdif.famdif_final.fragment.HomeFragment;
import com.famdif.famdif_final.fragment.IndexFragment;
import com.famdif.famdif_final.fragment.ListaUsuariosBorrarFragment;
import com.famdif.famdif_final.fragment.MapsFragment;
import com.famdif.famdif_final.fragment.MensajeSeleccionadoFragment;
import com.famdif.famdif_final.fragment.MessagesFragment;
import com.famdif.famdif_final.fragment.MySuggestionsFragment;
import com.famdif.famdif_final.fragment.NewsFragment;
import com.famdif.famdif_final.fragment.PollsFragment;
import com.famdif.famdif_final.fragment.RecordarContrasenaFragment;
import com.famdif.famdif_final.fragment.RegistrarFragment;
import com.famdif.famdif_final.fragment.SuggestionFragment;
import com.famdif.famdif_final.fragment.TiendaSeleccionadaFragment;
import com.famdif.famdif_final.fragment.polls.RegisterPollFragment;
import com.famdif.famdif_final.fragment.polls.TestPollFragment;
...
public class MainActivity extends AppCompatActivity {
   ...
   //     }
        ...
        if (null == mAuth.getCurrentUser() || mAuth.getCurrentUser().getEmail().isEmpty()) {
            ...
            setFragment(FragmentName.FIRST_TIME_WELCOME);
        } else {
    ...
    public void setFragment(FragmentName options) {
        ...
        switch (options) {
            ...
            case REMEMBER_PASSWORD:
                RecordarContrasenaFragment recordarContrasenaFragment = new RecordarContrasenaFragment();
                fragmentTransaction.replace(R.id.index_fragment, recordarContrasenaFragment);
                break;
            case FIRST_TIME_WELCOME:
                FirstTimeFragment firstTimeFragment = new FirstTimeFragment();
                fragmentTransaction.replace(R.id.index_fragment, firstTimeFragment);
                break;
